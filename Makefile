...
terminfo: fonts
	...
	infocmp alacritty     > /dev/null 2>&1 || (curl -fLO https://raw.githubusercontent.com/jwilm/alacritty/master/extra/alacritty.info; tic -xe alacritty,alacritty-direct alacritty.info; rm -f alacritty.info)
